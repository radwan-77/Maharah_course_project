...
import 'package:maharah_course_project/presentation/screens/home_screen/vertical_list_section_card.dart';
          ...
          child: Column(
            children: [
              ...
              const HorizontalListSectionCard(
                trendingCourse: TrendingCourseInfo.trendingCourses,
              ),
              const SizedBox(height: 32),
              const VerticalListSectionCard(
                mostTakenCourseModels:MostTakenCourseInfo.mostTakenCourses ,
              ),
            ],
          ),
        ),
