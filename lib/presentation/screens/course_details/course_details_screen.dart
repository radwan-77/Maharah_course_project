...
import 'package:maharah_course_project/presentation/screens/course_details/course_details_info.dart';
import 'package:maharah_course_project/presentation/screens/course_details/course_title_and_icon.dart';
import 'package:maharah_course_project/presentation/widgets/scaffold_with_floating_panel.dart';
...
class CourseDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<CartCubit, CartState>(
      ...
      child: ScaffoldWithFloatingPanel(
        body: Scaffold(
                ...
                onPressed: () {
                  context.read<CartCubit>().addItem(
                    Item(
                      ...
                      image: courseDetailsModel.image,
